...
const Footer = () => {
  ...
  return (
    <footer className="bg-dark pt-16 md:pt-20 lg:pt-24">
      <div className="container">
        ...
        <div className="mb-12 grid gap-8 md:grid-cols-2 lg:grid-cols-4">
          ...
          <div className="lg:col-span-1">
            ...
            <p className="mb-6 max-w-[270px] text-sm text-gray-400">
              Performance-Webseiten und SaaS-Lösungen für messbar mehr Aufträge und Umsatz. Spezialisiert auf Shopify, lokale Systeme und KI-Automation.
            </p>
            {/* Social Links */}
            <div className="flex gap-4">
              <a
                ...
                className="inline-flex h-10 w-10 items-center justify-center rounded-lg bg-primary/10 text-gray-400 hover:bg-primary hover:text-white transition"
                aria-label="Facebook"
              >
                <svg className="h-5 w-5 fill-current" viewBox="0 0 22 22">
          ...
          {/* Quick Links */}
          <div>
            <h3 className="mb-6 font-bold text-white">Navigation</h3>
            <ul className="space-y-3">
              ...
              <li>
                <Link href="/#contact" className="text-sm text-gray-400 hover:text-primary transition">
                  Kontakt
                </Link>
              </li>
              <li>
              ...
              <li>
                <Link href="/#pricing" className="text-sm text-gray-400 hover:text-primary transition">
                  Preise
                </Link>
              </li>
            </ul>
          ...
          {/* Legal */}
          <div>
            <h3 className="mb-6 font-bold text-white">Rechtliches</h3>
            <ul className="space-y-3">
              <li>
                <Link href="/impressum" className="text-sm text-gray-400 hover:text-primary transition">
                  Impressum
                </Link>
              </li>
              <li>
                <Link href="/datenschutz" className="text-sm text-gray-400 hover:text-primary transition">
        ...
        {/* Bottom Footer */}
        <div className="flex flex-col items-center justify-between gap-6 pb-12 md:flex-row">
          <p className="text-sm text-gray-400">
            &copy; {currentYear} Classy Marketing. Alle Rechte vorbehalten.
          </p>
